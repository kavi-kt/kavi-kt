...
class KaviTest {
  ...
  @Test
  fun topLevelMembersRetainOrder() {
    val source =
      FileSpec.builder(tacosPackage, "Taco")
        ...
        .addProperty(
          PropertySpec.builder("c", STRING, KModifier.PUBLIC).initializer("%S", "C").build()
        )
        .addFunction(FunSpec.builder("d").build())
        .addType(TypeSpec.classBuilder("E").build())
        .addProperty(
          PropertySpec.builder("f", STRING, KModifier.PUBLIC).initializer("%S", "F").build()
        )
        .build()
  ...
  @Test
  fun primaryConstructorProperties() {
    val source =
      FileSpec.get(
        tacosPackage,
        TypeSpec.classBuilder("Taco")
          .primaryConstructor(
            FunSpec.constructorBuilder()
              .addParameter("cheese", STRING)
              .addParameter("cilantro", STRING)
              .addParameter("lettuce", STRING)
              .beginControlFlow("require(!cheese.isEmpty())")
              .addStatement("%S", "cheese cannot be empty")
              .endControlFlow()
              .build()
          )
          .addProperty(PropertySpec.builder("cheese", STRING).initializer("cheese").build())
          .addProperty(
            PropertySpec.builder("cilantro", STRING).mutable().initializer("cilantro").build()
          )
          .addProperty(
            PropertySpec.builder("lettuce", STRING).initializer("lettuce.trim()").build()
          )
          .addProperty(PropertySpec.builder("onion", BOOLEAN).initializer("true").build())
          .build(),
      )
    assertThat(source.toString())
      .isEqualTo(
  ...
  @Test
  fun propertyModifiers() {
    val source =
      FileSpec.get(
        tacosPackage,
        TypeSpec.classBuilder("Taco")
          .addProperty(
            PropertySpec.builder("CHEESE", STRING, KModifier.PRIVATE, KModifier.CONST)
              .initializer("%S", "monterey jack")
              .build()
          )
          .addProperty(
            PropertySpec.builder("sauce", STRING, KModifier.PUBLIC)
              .mutable()
  ...
  @Test
  fun mistargetedModifier() {
    assertFailure { PropertySpec.builder("CHEESE", STRING, KModifier.DATA).build() }
      .isInstanceOf<IllegalArgumentException>()
  }
  ...
  /** When emitting a triple quote, Kavi escapes the 3rd quote in the triplet. */
  @Test
  fun rawStrings() {
    val source =
      FileSpec.get(
        ...
        TypeSpec.classBuilder("Taco")
          .addFunction(
            FunSpec.builder("addCheese")
              .addParameter(
                ParameterSpec.builder("kind", STRING).defaultValue("%S", "monterey jack").build()
              )
              .build()
          )
          .build(),
  ...
  @Test
  fun extensionFunctionLambda() {
    val source =
      FileSpec.builder(tacosPackage, "Taco")
        .addFunction(
          FunSpec.builder("shrink")
            .returns(STRING)
            .receiver(LambdaTypeName.get(parameters = arrayOf(STRING), returnType = STRING))
            .addStatement("return substring(0, length - 1)")
            .build()
        )
        .build()
  ...
  @Test
  fun extensionFunctionLambdaWithParamName() {
    val source =
      FileSpec.builder(tacosPackage, "Taco")
        .addFunction(
          FunSpec.builder("whatever")
            ...
            .receiver(
              LambdaTypeName.get(
                parameters = arrayOf(ParameterSpec.builder("name", STRING).build()),
                returnType = UNIT,
              )
            )
  ...
  @Test
  fun extensionFunctionLambdaWithMultipleParams() {
    val source =
      FileSpec.builder(tacosPackage, "Taco")
        .addFunction(
          FunSpec.builder("whatever")
              ...
              LambdaTypeName.get(
                parameters =
                  listOf(
                    ...
                    ParameterSpec.unnamed(INT),
                    ParameterSpec.builder("age", LONG).build(),
                  ),
                returnType = UNIT,
              )
            )
  ...
  fun extensionProperty() {
    val source =
      FileSpec.builder(tacosPackage, "Taco")
        .addProperty(
          PropertySpec.builder("extensionProperty", INT)
            .receiver(STRING)
  ...
  fun nullableTypes() {
    val list =
      (LIST.copy(nullable = true) as ClassName)
        .parameterizedBy(INT.copy(nullable = true))
        .copy(nullable = true)
  ...
  fun getAndSet() {
    val source =
      FileSpec.builder(tacosPackage, "Taco")
        .addProperty(
          PropertySpec.builder("propertyWithCustomAccessors", INT)
            .mutable()
            .initializer("%L", 1)
            .getter(
  ...
  @Test
  fun propertyWithLongInitializerWrapping() {
    val source =
      FileSpec.builder(tacosPackage, "Taco")
        .addProperty(
          PropertySpec.builder("foo", ClassName(tacosPackage, "Foo").copy(nullable = true))
  ...
  @Test
  fun suspendingLambdas() {
    val barType = ClassName(tacosPackage, "Bar")
    val suspendingLambda =
      LambdaTypeName.get(parameters = arrayOf(ClassName(tacosPackage, "Foo")), returnType = barType)
    ...
    val source =
      FileSpec.builder(tacosPackage, "Taco")
        ...
        .addFunction(FunSpec.builder("foo").addParameter("bar", suspendingLambda).build())
        .build()
    assertThat(source.toString())
      .isEqualTo(
        """
  ...
  // kmp: this test was extracted: enumAsDefaultArgument
        ...
        .addFunction(
          FunSpec.builder("dynamicTest")
            .addCode(
              CodeBlock.of(
                "%L",
                PropertySpec.builder("d1", DYNAMIC).initializer("%S", "Taco").build(),
              )
            )
            .addCode(
              CodeBlock.of("%L", PropertySpec.builder("d2", DYNAMIC).initializer("1f").build())
            )
  ...
  // kmp: this test was extracted: primaryConstructorParameterAnnotation

  // kmp: this test was extracted: importTypeArgumentInParameterizedTypeName

  // https://github.com/square/kotlinpoet/issues/462
  @Test
  fun foldingPropertyWithLambdaInitializer() {
    ...
    val property = PropertySpec.builder("foo", lambdaTypeName).initializer("foo").build()
    val file =
        ...
        .addType(
          TypeSpec.classBuilder("Taco")
            .primaryConstructor(
              FunSpec.constructorBuilder()
                .addParameter(
                  ParameterSpec.builder("foo", lambdaTypeName).defaultValue(initializer).build()
                )
                .build()
            )
  ...
  @Test
  fun foldingPropertyWithEscapedName() {
    val file =
      FileSpec.builder("com.squareup.tacos", "AlarmInfo")
        .addType(
          TypeSpec.classBuilder("AlarmInfo")
            .primaryConstructor(FunSpec.constructorBuilder().addParameter("when", FLOAT).build())
            .addProperty(PropertySpec.builder("when", FLOAT).initializer("when").build())
            .build()
        )
        .build()
    assertThat(file.toString())
  ...
  @Test
  fun noWrappingBetweenParamNameAndType() {
    val file =
      FileSpec.builder("com.squareup.tacos", "Taco")
        .addFunction(
          FunSpec.builder("functionWithAPrettyLongNameThatWouldCauseWrapping")
            .addParameter("parameterWithALongNameThatWouldAlsoCauseWrapping", STRING)
            .build()
        )
        .build()
    assertThat(file.toString())
  ...
  @Test
  fun noWrappingBetweenValAndPropertyName() {
      ...
      FileSpec.builder("com.squareup.tacos", "Taco")
        .addType(
          TypeSpec.classBuilder("Taco")
            ...
            .primaryConstructor(
              FunSpec.constructorBuilder()
                .addParameter(ParameterSpec.builder("name", STRING).build())
                .build()
            )
            .build()
        )
  ...
  @Test
  fun wrappingInsideKdocKeepsKdocFormatting() {
    val file =
      FileSpec.builder("com.squareup.tacos", "Taco")
        .addType(
          TypeSpec.classBuilder("Builder")
            ...
            .addFunction(
              FunSpec.builder("summary_text")
                ...
                .addParameter("summary_text", STRING.copy(nullable = true))
  ...
  @Test
  fun typeNamesInsideTemplateStringsGetImported() {
    val taco = ClassName("com.squareup.tacos", "Taco")
    val file =
      FileSpec.builder("com.squareup.example", "Tacos")
        .addFunction(
  ...
  // https://github.com/square/kotlinpoet/issues/606
  @Test
  fun memberNamesInsideTemplateStringsGetImported() {
  ...
  @Test
  fun allowIllegalCharactersInAutoEscapedIdentifiers() {
    val enum =
    ...
    val type = TypeSpec.classBuilder("Foo.Bar").build()
  ...
  // https://github.com/square/kotlinpoet/issues/2203
  @Test
  fun allowIllegalCharactersInManuallyEscapedIdentifiers() {
    val enum = TypeSpec.enumBuilder("MyEnum").addEnumConstant("`with.dots`").build()
    assertThat(enum.toString())
      .isEqualTo(
        """
        public enum class MyEnum {
  ...
  @Test
  fun percentAtTheEndOfKdoc() {
    val paramSpec1 = ParameterSpec.builder("a", INT).addKdoc("Progress in %%").build()
    val paramSpec2 = ParameterSpec.builder("b", INT).addKdoc("Some other parameter with %%").build()
    val funSpec = FunSpec.builder("test").addParameters(listOf(paramSpec1, paramSpec2)).build()
  ...
  @Test
  fun superClassGetsFullyQualifiedOnConflict() {
    val namespace = "test"

    val kotlinExceptionName = ClassName("kotlin", "Exception")
    val customExceptionName = ClassName(namespace, "Exception")
    val customException =
      TypeSpec.classBuilder("Exception")
        .superclass(kotlinExceptionName)
        .addFunction(FunSpec.builder("test").addParameter("e", customExceptionName).build())
        .build()

    val file = FileSpec.builder(namespace, "Exception").addType(customException).build()
    assertThat(file.toString())
      .isEqualTo(
        """
        |package test
  ...
  @Test
  fun allStringsAreUnderscore() {
    val file =
      FileSpec.builder("com.squareup.tacos", "SourceWithUnderscores")
        .addType(
          TypeSpec.classBuilder("SourceWithUnderscores")
            .primaryConstructor(
              FunSpec.constructorBuilder()
                .addParameter("_", FLOAT)
                .addParameter("____", FLOAT)
                .build()
            )
            .addProperty(PropertySpec.builder("_", FLOAT).initializer("_").build())
            .addProperty(PropertySpec.builder("____", FLOAT).initializer("____").build())
            .build()
        )
        .build()
    assertThat(file.toString())
  ...
  @Test
  fun generatedImportAliasesSamePackageDifferentContainingClasses() {
    val strokeCapRound =
      MemberName(
        enclosingClassName =
          ClassName("androidx.compose.ui.graphics", "StrokeCap").nestedClass("Companion"),
        simpleName = "Round",
      )
    val strokeJoinRound =
      MemberName(
        enclosingClassName =
          ClassName("androidx.compose.ui.graphics", "StrokeJoin").nestedClass("Companion"),
        simpleName = "Round",
      )
    val file =
      FileSpec.builder("com.example", "Test")
  ...
  @Test
  fun memberImportsOverGeneratedImportAliases() {
    val squareTaco = ClassName("com.squareup.tacos", "Taco")
    val blockTaco = ClassName("xyz.block.tacos", "Taco")
    val kotlinIsNullOrEmpty = MemberName("kotlin.text", "isNullOrEmpty")
    val cashIsNullOrEmpty = MemberName("com.squareup.cash.util", "isNullOrEmpty")
  ...
  @Test
  fun extensionFunctionIsImportedEvenIfTheSameIsUsedAlsoFromTheCurrentPackage() {
    val kotlinIsNullOrEmpty =
      MemberName(packageName = "kotlin.text", simpleName = "isNullOrEmpty", isExtension = true)
    val samePackageIsNullOrEmpty =
      MemberName(packageName = "com.example", simpleName = "isNullOrEmpty", isExtension = true)
    val file =
      FileSpec.builder("com.example", "Test")
        .addFunction(
          FunSpec.builder("main")
  ...
  @Test
  fun extensionFunctionIsImportedEvenIfTheSameTypeIsAlreadyImported() {
    val subpkgIsNullOrEmpty =
      ClassName(packageName = "com.example.subpkg", simpleNames = listOf("isNullOrEmpty"))
    val kotlinIsNullOrEmpty =
      MemberName(packageName = "kotlin.text", simpleName = "isNullOrEmpty", isExtension = true)
    val file =
      FileSpec.builder("com.example", "Test")
  ...
  @Test
  fun nestedClassesWithConflictingAutoGeneratedImports() {
    val source =
      FileSpec.builder("com.squareup.tacos", "Taco")
        .addType(
          TypeSpec.classBuilder("Taco")
  ...
  // https://github.com/square/kotlinpoet/issues/1563
  @Test
  fun nestedClassesWithConflictingManuallySuppliedImports() {
    val source =
      FileSpec.builder("com.squareup.tacos", "Taco")
  ...
  @Test
  fun importAliasCollisionWithRegularImportWhenAliasesComputedFirst() {
  ...
  // https://github.com/square/kotlinpoet/issues/2046
  @Test
  fun importAliasCollisionWithImportWhenRegularImportComputedFirst() {
    val class1 = ClassName("com.squareup.taco", "Meal")
    val class2 = ClassName("com.squareup.burrito", "Meal")
    val class3 = ClassName("com.squareup.meal", "TacoMeal")
    val source =
  ...
  // https://github.com/square/kotlinpoet/issues/2046
  @Test
  fun importAliasCollisionWithImportWhenWeRunOutOfSegments() {
    ...
    val source =
      FileSpec.builder("squareup.food", "Food")
        .addType(
          TypeSpec.classBuilder("Food")
