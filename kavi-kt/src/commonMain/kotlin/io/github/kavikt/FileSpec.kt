...
private constructor(builder: Builder, private val tagMap: TagMap = builder.buildTagMap()) :
  ...
  internal val extension = if (isScript) "kts" else "kt"
  ...
  private fun emit(codeWriter: CodeWriter, collectingImports: Boolean) {
    ...
    val imports =
      nonAliasedImports
        ...
        .distinct()
        .sorted()
        .plus(aliasedImports.map { it.toString() }.distinct().sorted())
        .toList()
...
internal val KOTLIN_DEFAULT_IMPORTS =
  setOf(
    "kotlin",
    "kotlin.annotation",
    "kotlin.collections",
...
internal val KOTLIN_DEFAULT_JVM_IMPORTS = setOf("java.lang")
internal val KOTLIN_DEFAULT_JS_IMPORTS = setOf("kotlin.js")
