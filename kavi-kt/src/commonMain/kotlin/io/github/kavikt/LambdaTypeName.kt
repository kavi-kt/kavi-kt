...
private constructor(
  ...
  @property:ExperimentalKaviApi public val contextReceivers: List<TypeName> = emptyList(),
  @property:ExperimentalKaviApi public val contextParameters: List<TypeName> = emptyList(),
