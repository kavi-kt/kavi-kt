...
internal constructor(
  ...
  override fun equalsWithGuard(other: TypeName, seen: RecursiveComparison): Boolean {
    ...
    // cut the cycle instead of overflowing the stack. (square/kotlinpoet#1737)
  ...
  override fun hashCode(): Int {
    ...
    // `Enum<E : Enum<E>>` and would recurse forever. equals still compares bounds.
  ...
  public companion object {
    internal fun of(name: String, bounds: List<TypeName>, variance: KModifier?): TypeVariableName {
      ...
      require(bounds.isNotEmpty()) { "$name has no bounds" }
    ...
    public operator fun invoke(
      ...
      of(name = name, bounds = bounds.toList().ifEmpty(::NULLABLE_ANY_LIST), variance = variance)
    ...
    internal val JAVA_OBJECT = ClassName("java.lang", "Object")
  }
}
