...
class FacadeFileTest : MultiClassInspectorTest() {
  ...
  fun facadeFile_reflective() {
    val fileSpec =
      Class.forName("io.github.kavikt.metadata.specs.FacadeFile").kotlin.toFileSpecWithTestHandler()
    assertThat(fileSpec.name).isEqualTo("FacadeFile")
    // language=kotlin
    assertThat(fileSpec.trimmedToString())
      .isEqualTo(
        """
        ...
        import io.github.kavikt.metadata.specs.FileAnnotation
  ...
  @IgnoreForHandlerType(handlerType = ELEMENTS, reason = "JvmName not possible in reflection")
  @Test
  fun noJvmName_reflective() {
    val fileSpec =
      Class.forName("io.github.kavikt.metadata.specs.NoJvmNameFacadeFileKt")
        .kotlin
        .toFileSpecWithTestHandler()
  ...
  @IgnoreForHandlerType(handlerType = REFLECTIVE, reason = "JvmName not possible in reflection")
  @Test
  ...
  fun jvmName_with_kt_reflective() {
    val fileSpec =
      Class.forName("io.github.kavikt.metadata.specs.JvmNameKt").kotlin.toFileSpecWithTestHandler()
