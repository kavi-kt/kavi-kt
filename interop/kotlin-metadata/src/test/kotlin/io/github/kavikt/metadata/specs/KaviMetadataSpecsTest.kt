...
import io.github.kavikt.LIST
import io.github.kavikt.ParameterizedTypeName.Companion.parameterizedBy
import io.github.kavikt.STRING
import io.github.kavikt.TypeSpec
import io.github.kavikt.metadata.specs.MultiClassInspectorTest.ClassInspectorType.ELEMENTS
import io.github.kavikt.metadata.specs.MultiClassInspectorTest.ClassInspectorType.REFLECTIVE
import io.github.kavikt.tag
import io.github.kavikt.tags.TypeAliasTag
...
class KaviMetadataSpecsTest : MultiClassInspectorTest() {

  @Test
  fun constructorData() {
    val typeSpec = ConstructorClass::class.toTypeSpecWithTestHandler()
    // language=kotlin
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        """
  ...
  fun supertype() {
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        """
        public class Supertype() : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.BaseType(), io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.BaseInterface
        """
          .trimIndent()
      )
  }
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        ...
        public class TypeAliases(
          public val foo: io.github.kavikt.metadata.specs.TypeAliasName,
          public val bar: io.github.kavikt.metadata.specs.GenericTypeAlias,
        )
        """
          .trimIndent()
      )
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        ...
        public class NestedTypeAliasTest() {
          public val prop: io.github.kavikt.metadata.specs.NestedTypeAlias = throw NotImplementedError("Stub!")
        }
        """
          .trimIndent()
      )
  ...
  fun overriddenThings() {
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        """
        public abstract class OverriddenThings() : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.OverriddenThingsBase(), io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.OverriddenThingsInterface {
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        ...
        public enum class EnumWithAnnotation() {
          FOO,
          @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.FieldAnnotation
          BAR,
          BAZ,
        }
        """
  ...
  fun interfaces() {
    ...
    // language=kotlin
    assertThat(testInterfaceSpec.trimmedToString())
      .isEqualTo(
        """
    ...
    // language=kotlin
    assertThat(subInterfaceSpec.trimmedToString())
      .isEqualTo(
        """
        public interface SubInterface : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.TestInterface {
    ...
    // language=kotlin
    assertThat(implSpec.trimmedToString())
      .isEqualTo(
        """
        public class TestSubInterfaceImpl() : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.SubInterface {
  ...
  fun functionTypeArgsSupersedeClass() {
    ...
    val func1TypeVar =
      typeSpec.funSpecs.find { it.name == "functionAlsoWithT" }!!.typeVariables.first()
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        ...
        public class ComplexCompanionObject() {
          public companion object ComplexObject : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.CompanionBase(), io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.CompanionInterface
        }
        """
          .trimIndent()
      )
  ...
  fun annotationsAreCopied() {
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        """
        public class AnnotationHolders @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.ConstructorAnnotation constructor() {
          @field:io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.FieldAnnotation
          public var `field`: kotlin.String? = null

          @get:io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.GetterAnnotation
          public var getter: kotlin.String? = null

          @set:io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.SetterAnnotation
          public var setter: kotlin.String? = null

          @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.HolderAnnotation
          @kotlin.jvm.JvmField
          public var holder: kotlin.String? = null

          @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.ConstructorAnnotation
          public constructor(`value`: kotlin.String)

          @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.FunctionAnnotation
          public fun function() {
          }
        }
        """
  ...
  @Retention(RUNTIME) annotation class ConstructorAnnotation

  @Retention(RUNTIME) annotation class FieldAnnotation

  @Retention(RUNTIME) annotation class GetterAnnotation

  @Retention(RUNTIME) annotation class SetterAnnotation

  @Retention(RUNTIME) annotation class HolderAnnotation

  @Retention(RUNTIME) annotation class FunctionAnnotation

  @IgnoreForHandlerType(
    reason =
      "Elements properly resolves the regular properties + JvmStatic, but reflection will not",
    handlerType = REFLECTIVE,
  )
  @Test
  ...
  class Constants(val param: String = "param") {
    val boolProp = false
  ...
  fun jvmAnnotations() {
    ...
    // language=kotlin
    assertThat(interfaceSpec.trimmedToString())
      .isEqualTo(
        """
  ...
  @IgnoreForHandlerType(
    reason =
      "Reflection properly resolves companion properties + JvmStatic + JvmName, but " +
        "elements will not",
    handlerType = ELEMENTS,
  )
  @Test
  ...
  class JvmNameData(@get:JvmName("jvmParam") val param: String) {

    @get:JvmName("jvmPropertyGet") val propertyGet: String? = null

    @set:JvmName("jvmPropertySet") var propertySet: String? = null

    @set:JvmName("jvmPropertyGetAndSet")
    @get:JvmName("jvmPropertyGetAndSet")
    var propertyGetAndSet: String? = null

    @JvmName("jvmFunction") fun function() {}
    ...
    interface InterfaceWithJvmName {
      companion object {
        @JvmStatic @get:JvmName("fooBoolJvm") val FOO_BOOL = false

        @JvmName("jvmStaticFunction") @JvmStatic fun staticFunction() {}
      }
    }
  }
  ...
  constructor(
    ...
    @JvmOverloads
    fun testFunction(param1: String, optionalParam2: String = "", nullableParam3: String? = null) {}
  }

  @IgnoreForHandlerType(reason = "Elements generates initializer values.", handlerType = ELEMENTS)
  @Test
  ...
  @IgnoreForHandlerType(reason = "Elements generates initializer values.", handlerType = REFLECTIVE)
  @Test
  ...
  class Fields(@JvmField val param1: String) {
  ...
  @IgnoreForHandlerType(
    reason =
      "Synthetic constructs aren't available in elements, so some information like " +
  ...
  class Synthetics(@get:JvmSynthetic val param: String) {

    @JvmSynthetic val property: String? = null

    @field:JvmSynthetic val fieldProperty: String? = null

    @get:JvmSynthetic val propertyGet: String? = null

    @set:JvmSynthetic var propertySet: String? = null

    @set:JvmSynthetic @get:JvmSynthetic var propertyGetAndSet: String? = null

    @JvmSynthetic fun function() {}
    ...
    interface InterfaceWithJvmName {
      @JvmSynthetic fun interfaceFunction()

      companion object {
        @JvmStatic @get:JvmSynthetic val FOO_BOOL = false

        @JvmSynthetic @JvmStatic fun staticFunction() {}
      }
    }
  }
  ...
  class Throwing @Throws(IllegalStateException::class) constructor() {
    ...
    @get:Throws(IllegalStateException::class) val getterThrows: String? = null

    @set:Throws(IllegalStateException::class) var setterThrows: String? = null

    @get:Throws(IllegalStateException::class)
    @set:Throws(IllegalStateException::class)
    var getterAndSetterThrows: String? = null

    @Throws(IllegalStateException::class) fun testFunction() {}
  }
  ...
  @IgnoreForHandlerType(
    reason =
      "compile-testing can't handle class names with dashes, will throw " +
        "\"class file for io.github.kavikt.metadata.specs.Fuzzy\$ClassNesting\$-Nested not found\"",
    handlerType = ELEMENTS,
  )
  @Test
  ...
  @IgnoreForHandlerType(
    reason =
      "Property site-target annotations are always stored on the synthetic annotations " +
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        ...
        public class ParameterAnnotations(
          @property:io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.CustomAnnotation(name = "${'$'}{'${'$'}'}a")
          @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.CustomAnnotation(name = "b")
          public val param1: kotlin.String,
          @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.CustomAnnotation(name = "2")
          param2: kotlin.String,
        ) {
          public fun function(@io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.CustomAnnotation(name = "woo") param1: kotlin.String) {
          }
        }
        """
          .trimIndent()
  ...
  fun classAnnotations_reflective() {
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        """
        @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.RuntimeCustomClassAnnotation(name = "Runtime")
  ...
  fun classAnnotations_elements() {
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        """
        @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.BinaryCustomClassAnnotation(name = "Binary")
        @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.RuntimeCustomClassAnnotation(name = "Runtime")
        public class ClassAnnotations()
        """
          .trimIndent()
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        ...
        public class TypeAnnotations() {
          public val foo: kotlin.collections.List<@io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.TypeAnnotation kotlin.String> = throw NotImplementedError("Stub!")

          public fun <T> bar(input: @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.TypeAnnotation kotlin.String, input2: @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.TypeAnnotation (@io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.TypeAnnotation kotlin.Int) -> @io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.TypeAnnotation kotlin.String) {
          }
        }
        """
          .trimIndent()
  ...
  @Target(TYPE, TYPE_PARAMETER) annotation class TypeAnnotation
  ...
  fun backwardTypeVarReferences() {
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        """
        public class Asset<A : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.Asset<A>>() {
          public fun <D : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.Asset<D>, C : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.Asset<A>> function() {
          }

          public class AssetOut<out B : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.Asset.AssetOut<B>>()

          public class AssetIn<in C : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.Asset.AssetIn<C>>()
        }
        """
          .trimIndent()
      )
  ...
  fun modalities() {
    ...
    // language=kotlin
    assertThat(abstractModalities.trimmedToString())
      .isEqualTo(
        """
        public abstract class AbstractModalities() : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.ModalitiesInterface {
    ...
    // language=kotlin
    assertThat(finalAbstractModalities.trimmedToString())
      .isEqualTo(
        """
        public abstract class FinalAbstractModalities() : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.ModalitiesInterface {
    ...
    // language=kotlin
    assertThat(modalities.trimmedToString())
      .isEqualTo(
        """
        public class Modalities() : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.AbstractModalities() {
          override val interfaceProp: kotlin.String? = null
  ...
  fun funClass() {
    ...
    // language=kotlin
    assertThat(funInterface.trimmedToString())
      .isEqualTo(
        """
    ...
    // language=kotlin
    assertThat(subFunInterface.trimmedToString())
      .isEqualTo(
        """
        public fun interface SubFunInterface : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.FunInterface
        """
          .trimIndent()
      )
  }
  ...
  fun selfReferencingTypeParams() {
    ...
    assertThat(typeSpec.trimmedToString())
      .isEqualTo(
        """
        public open class Node<T : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.Node<T, R>, R : io.github.kavikt.metadata.specs.KaviMetadataSpecsTest.Node<R, T>>() {
          public var t: T? = null
