...
class KmAnnotationsTest {
  ...
  fun noMembers() {
    ...
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun byteValue() {
    val annotation = KmAnnotation("test/ByteValueAnnotation", mapOf("value" to ByteValue(2)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun charValue() {
    val annotation = KmAnnotation("test/CharValueAnnotation", mapOf("value" to CharValue('2')))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun shortValue() {
    val annotation = KmAnnotation("test/ShortValueAnnotation", mapOf("value" to ShortValue(2)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun intValue() {
    val annotation = KmAnnotation("test/IntValueAnnotation", mapOf("value" to IntValue(2)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun longValue() {
    val annotation = KmAnnotation("test/LongValueAnnotation", mapOf("value" to LongValue(2L)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun floatValue() {
    val annotation = KmAnnotation("test/FloatValueAnnotation", mapOf("value" to FloatValue(2.0F)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun doubleValue() {
    val annotation = KmAnnotation("test/DoubleValueAnnotation", mapOf("value" to DoubleValue(2.0)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  fun booleanValue() {
    val annotation =
      KmAnnotation("test/BooleanValueAnnotation", mapOf("value" to BooleanValue(true)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun uByteValue() {
    val annotation = KmAnnotation("test/UByteValueAnnotation", mapOf("value" to UByteValue(2u)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun uShortValue() {
    val annotation = KmAnnotation("test/UShortValueAnnotation", mapOf("value" to UShortValue(2u)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  @Test
  fun uIntValue() {
    val annotation = KmAnnotation("test/UIntValueAnnotation", mapOf("value" to UIntValue(2u)))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  fun stringValue() {
    val annotation =
      KmAnnotation("test/StringValueAnnotation", mapOf("value" to StringValue("taco")))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
  ...
  fun kClassValue() {
    val annotation =
      KmAnnotation("test/KClassValueAnnotation", mapOf("value" to KClassValue("test/OtherClass")))
    assertThat(annotation.toAnnotationSpec().toString())
      .isEqualTo(
        """
