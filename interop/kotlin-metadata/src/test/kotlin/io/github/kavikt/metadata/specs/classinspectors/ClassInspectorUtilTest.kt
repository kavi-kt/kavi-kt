 ...
 */
package io.github.kavikt.metadata.specs.classinspectors
...
class ClassInspectorUtilTest {
  ...
  @Test
  fun createClassName_noEmptyNames() {
  ...
  @Test
  fun createClassName_packageWithCaps() {
    assertThat(ClassInspectorUtil.createClassName("some/Path/Foo.Nested"))
      .isEqualTo(ClassName("some.Path", "Foo", "Nested"))
  }

  @Test
  fun throwsSpec_normal() {
